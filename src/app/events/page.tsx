...
<Link href="/verify" style={{ fontSize: '14px', fontWeight: 500, color: '#4B4869', textDecoration: 'none' }}>Verify</Link>
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '1200px', margin: '0 auto', padding: '80px 48px 0', display: 'grid', gridTemplateColumns: '1fr 1fr', alignItems: 'center', gap: '40px', minHeight: 'calc(100vh - 72px)' }}>
          <div style={{ paddingBottom: '80px' }}>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <button style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.15)', color: 'white', border: '1.5px solid rgba(255,255,255,0.4)', borderRadius: '50px', padding: '14px 28px', fontSize: '15px', fontWeight: 600, cursor: 'pointer', backdropFilter: 'blur(8px)', fontFamily: 'inherit' }}>
                ✨ Create Event
              </button>
            </div>
          </div>
      ...
      <div style={{ background: 'white', borderTop: '1px solid #E8E4F5', borderBottom: '1px solid #E8E4F5', padding: '28px 48px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '24px' }}>
          {[
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '0 24px', borderRight: i < 3 ? '1px solid #E8E4F5' : 'none' }}>
            ...
            <Link href={`/ticket/${i + 1}`} key={i} style={{ textDecoration: 'none', background: 'white', border: '1px solid #E8E4F5', borderRadius: '18px', overflow: 'hidden', display: 'block', transition: 'transform 0.3s' }}>
              ...
              <div style={{ padding: '18px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid #E8E4F5', paddingTop: '14px' }}>
                  ...
                  <button style={{ background: 'linear-gradient(135deg,#7C3AED,#A855F7)', color: 'white', border: 'none', borderRadius: '50px', padding: '9px 18px', fontSize: '13px', fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' }}>
                    Mint Ticket
                  </button>
                </div>
              </div>
      ...
      {/* HOW IT WORKS */}
      <div style={{ background: '#FAFAFF', borderTop: '1px solid #E8E4F5', borderBottom: '1px solid #E8E4F5', padding: '80px 48px' }}>
      ...
      <div style={{ padding: '80px 48px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', background: 'linear-gradient(135deg,#7C3AED,#EC4899)', borderRadius: '28px', padding: '64px 72px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '40px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', flexShrink: 0, position: 'relative', zIndex: 1 }}>
            <button style={{ background: 'white', color: '#7C3AED', border: 'none', borderRadius: '50px', padding: '14px 28px', fontSize: '15px', fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' }}>🚀 Create Event</button>
            <button style={{ background: 'rgba(255,255,255,0.15)', color: 'white', border: '1.5px solid rgba(255,255,255,0.4)', borderRadius: '50px', padding: '14px 28px', fontSize: '15px', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' }}>Learn More →</button>
          </div>
        </div>
      </div>
